...
const SafeMultisigPolicy = createVincentToolPolicy({
  ...
  toolParameterMappings: {
    ...
    executingToolParams: "executingToolParams",
  },
});
...
export const vincentTool = createVincentTool({
  ...
  precheck: async ({ toolParams }, { succeed, fail }) => {
    ...
    if (rpcUrl && typeof rpcUrl === "string") {
      try {
        ...
        return fail({
          error:
            "[@lit-protocol/vincent-tool-native-send/precheck] Invalid RPC URL format",
        });
      }
    }
  ...
  execute: async (
    ...
    try {
      ...
      console.log(
        "[@lit-protocol/vincent-tool-native-send/execute] Using RPC URL:",
        finalRpcUrl
      );
